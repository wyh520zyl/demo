...
public class SingleTaskTestActivity extends AppCompatActivity {
    ...
    public static void installApk(@NonNull Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri apkUri = FileProvider.getUriForFile(context,  "com.yuanmalian.live.fileprovider", file);
    ...
    private static class ViewHolder {
        ...
        public void updateCompleted(final BaseDownloadTask task) {
            ...
            toast(String.format("completed %d %s", position+123, task.getTargetFilePath()));
