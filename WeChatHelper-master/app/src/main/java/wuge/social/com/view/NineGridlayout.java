...
//                System.out.println("需要进入第二给页面discover_all_content:" + discover.getCircle_id());
//                if (!DiscoverItemPart.present.equals(CommUtil.now)) {
//                    if(CommUtil.now.equals(HomeActivity.present)){
//                        Intent intent = new Intent(homeActivity, DiscoverItemPart.class);
//                        DiscoverItemPart.previous=HomeActivity.present;
//                        homeActivity.startActivity(intent);
//                        homeActivity.dis=discover;
//                    }else if(CommUtil.now.equals(RecyclerViewActivity.present)){
