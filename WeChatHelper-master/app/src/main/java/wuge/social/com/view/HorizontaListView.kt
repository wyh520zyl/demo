...
class HorizontalListView(context: Context?, attrs: AttributeSet?) :
    ...
    private fun addAndMeasureChild(child: View, viewPos: Int) {
        ...
        if (params == null) {
            params = LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT)
        }
    ...
    protected fun onFling(velocityX: Float): Boolean {
    ...
    protected fun onDown(): Boolean {
        mScroller!!.forceFinished(true)
        return true
    }

    private val mOnGesture: GestureDetector.OnGestureListener =
        object : GestureDetector.SimpleOnGestureListener() {
            override fun onDown(e: MotionEvent): Boolean {
                return this@HorizontalListView.onDown()
            }
            ...
            override fun onFling(
                ...
                return this@HorizontalListView.onFling(velocityX)
            }
