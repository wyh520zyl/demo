...
public class MediaGridFragment extends BaseFragment implements MediaGridView, RecyclerViewFinal.OnLoadMoreListener,
    ...
    public void onRequestMediaCallback(List<MediaBean> list) {
        ...
        Logger.i("MediaGridFragment5");
        mRvMedia.onLoadMoreComplete();
        Logger.i("MediaGridFragment6");
    }
...
//        captureIntent.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 1);
    ...
    public void refreshUI() {
        try {
            ...
            refreshRecyclerViewActivity(mCropPath.getPath());
//            Intent intent=new Intent();
//            intent.putExtra("date",mCropPath.getPath());
//            Objects.requireNonNull(getActivity()).setResult(RESULT_OK, intent);
     ...
     */
    private void refreshRecyclerViewActivity(String str){
