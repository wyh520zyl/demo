...
public class DetailInfoFragment1 extends Fragment  {
    ...
    public static DetailInfoFragment1 newInstance(Context context, int param, ViewPager viewpager) {
        DetailInfoFragment1 fragment = new DetailInfoFragment1();
